...
<?php } ?>
    ...
    <tfoot>
        ...
        <?php if (isset($modules['coupon']) || isset($modules['reward']) || isset($modules['voucher'])) { ?>
            <tr>
                <td class="total" colspan="<?php echo !$is_mobile ? 7 : 5 ?>"><a id="simplecheckout_button_cart" onclick="simplecheckout_reload('from_cart');" class="simplecheckout-button"><span><?php echo $button_update; ?></span></a></td>
            </tr>
        <?php } ?>
    </tfoot>
</table>
