...
<tr>
<td style="width: 1px;">
  <input type="radio" class="emss" name="shipping_method" value="<?php echo $quote['code']; ?>" id="<?php echo $quote['code']; ?>"<?php echo $code == $quote['code'] ? 'checked="checked"' : ''?> />
</td>
<td>
...
<tr>
    ...
    <td  style="color:#555; font-size: 11px;"><?php if (isset($quote['description'])){echo $quote['description'];} ?></td>
    <td></td>
</tr>
<?php endforeach;?>
