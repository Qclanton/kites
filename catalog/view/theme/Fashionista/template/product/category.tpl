...
//echo('</pre>');
	                    ...
	                    <p class="name">
	                        <a href="<?php echo $product[ 'href' ]; ?>"><span class="upper"><?php echo $product[ 'name' ]; ?></span>
	                        <span class="year"><?php echo $product[ 'model' ]; ?></span></a>
	                    </p>
	                    <p class="price">
				...
				<?php } ?>
                        ...
                        <?php if( $trio > 2) { ?></div><div class="trio"><?php $trio = 1; } else { $trio++; } ?>
                    <?php } ?>
		  </div>
                </div>
