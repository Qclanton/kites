    ...
    <?php if (!empty($shipping_methods)) { ?>
        <table class="simplecheckout-methods-table">
            <?php foreach ($shipping_methods as $shipping_method) { ?>
                ...
                <tr>
                    <td colspan="3" style="font-weight: bold;"><b><?php echo $shipping_method['title']; ?></b></td>
                </tr>
                <?php } ?>
                ...
                <?php if (empty($shipping_method['error'])) { ?>
                    <?php foreach ($shipping_method['quote'] as $quote) { ?>
                        <tr>
                            <td class="code" style="padding:5px 0 0 0;">
                            ...
                            <td class="title" valign="middle" style="padding:5px 0 0 10px;">
                                <?php if ($quote['code']=='pickup2.pickup2') { ?>
                                <label for="<?php echo $quote['code']; ?>">
                                   Другое
                                </label>

<input type="text" onchange="simplecheckout_reload('from_payment')" id="newpay" name="newpay" />
