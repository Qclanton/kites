...
<div class="right">
  ...
  <select name="country_id" class="large-field" onchange="$('#payment-address select[name=\'zone_id\']').load('<?php echo HTTP_SERVER; ?>index.php?route=checkout/address/zone&country_id=' + this.value);">
...
<?php } ?>
  ...
  <div class="button c1"><a id="button-guest" href="#"><span><?php echo $button_continue; ?></span></a></div>
<div class="c"></div>
<script type="text/javascript"><!--
$('#payment-address select[name=\'zone_id\']').load('<?php echo HTTP_SERVER; ?>index.php?route=checkout/address/zone&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>');
//--></script> 