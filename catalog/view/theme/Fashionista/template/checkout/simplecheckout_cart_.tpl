            ...
            <tr>
                <?php if ($template == 'shoppica' || $template == 'shoppica2') { ?>
                    <td class="total" colspan="7">
						<div class="button c1"><a id="simplecheckout_button_cart" onclick="update_simplecheckout_cart();" class="s_button_1 s_main_color_bgr"><span class="s_text"><?php echo $button_update; ?></span></a></div>
						<div class="c"></div>
					</td>
                <?php } else { ?>
                    <td class="total" colspan="7">
					<div class="button c1"><a id="simplecheckout_button_cart" onclick="update_simplecheckout_cart();" class="simplecheckout-button"><span><?php echo $button_update; ?></span></a></td></div>
					<div class="c"></div>
                <?php } ?>
            </tr>
        <?php } ?>
