        ...
        <table class="simplecheckout-login">
            ...
            <tr>
                ...
                <?php if ($template == 'shoppica' || $template == 'shoppica2') { ?>
                    <td class="simplecheckout-login-right">
						<div class="button c1"><a id="simplecheckout_button_login" class="s_button_1 s_main_color_bgr"><span class="s_text"><?php echo $button_login; ?></span></a></div>
						<div class="c"></div>
						</td>
                <?php } else { ?>
                    <td class="simplecheckout-login-right">
						<div class="button c1"><a id="simplecheckout_button_login" class="simplecheckout-button"><span><?php echo $button_login; ?></span></a></div>
						<div class="c"></div>
					</td>
                <?php } ?>
            </tr>
