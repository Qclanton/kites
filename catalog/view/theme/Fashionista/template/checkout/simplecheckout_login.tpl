<div id="simplecheckout_login">
    ...
    <table class="simplecheckout-login">
        ...
        <tr>
            <td></td>
            <td class="simplecheckout-login-right"><a id="simplecheckout_button_login" onclick="simplecheckout_login()" class="simplecheckout-button"><span><?php echo $button_login; ?></span></a></td>
        </tr>
    </table>
</div>
<?php if ($redirect) { ?>
