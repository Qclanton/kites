...
<?php } ?>
    ...
    <div class="simplecheckout-button-block" id="buttons" <?php if ($block_order) { ?>style="display:none;"<?php } ?>>
		...
		<td width="100" style="padding-left:845px;">
			...
			<div class="button" style="background-color:#911E42;"><a class="simplecheckout-button" onclick="simplecheckout_submit();" id="simplecheckout_button_confirm"><span><?php echo $button_order; ?></span></a></div>
			<div class="c"></div>
        </div>
