...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['accessory_options'] = array();
			...
			foreach ($results as $result) {
				...
				$this->data['accessories'][$result['product_id']] = array(
					...
					'href_description' => $this->url->link('product/product/getdescription', 'product_id=' . $result['product_id'])
				);
				...
				foreach ($this->model_catalog_product->getProductOptions($result['product_id']) as $option) { 
					if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image') { 
						...
						$this->data['accessory_options'][$result['product_id']][] = array(
							'product_option_id' => $option['product_option_id'],
							'option_id'         => $option['option_id'],
							'name'              => $option['name'],
							'type'              => $option['type'],
