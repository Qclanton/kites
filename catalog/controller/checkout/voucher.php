...
class ControllerCheckoutVoucher extends Controller { 
	...
	public function index() {
		...
		$this->data['entry_amount'] = sprintf($this->language->get('entry_amount'), $this->currency->format(1, false, 1), $this->currency->format(100000, false, 1));
	...
	private function validate() {
		...
		if (($this->request->post['amount'] < 1) || ($this->request->post['amount'] > 100000)) {
      		$this->error['amount'] = sprintf($this->language->get('error_amount'), $this->currency->format(1, false, 1), $this->currency->format(100000, false, 1) . ' ' . $this->currency->getCode());
    	}
